...
<div style="background-image: url('images/student2.jpg');padding: 40px;height:auto;background-size: 100%;">
    <div class="container-fluid">
        <form action="student_edit_action.php" method="get">
            <div class="row">
                <div class="col-md-3">
                </div>
                <div class="col-md-6">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                while($row2=mysqli_fetch_array($result2))
                                {
                                    ...
                                    <td><input type="text"name="ug_major" value="<?php echo $row2[2] ?>"></td>
                                    <td><input type="number"name="ug_gpa" value="<?php echo $row2[3] ?>"></td>
                                    <td><input type="text" name="ug_university" value="<?php echo $row2[4] ?>"></td>
                                    <td><input type="text" name="ug_country" value="<?php echo $row2[5] ?>"></td>
                                    <td><input type="number" name="ug_year" value="<?php echo $row2[6] ?>"></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                while($row3=mysqli_fetch_array($result3))
                                {
                                    ...
                                    <td><input type="text" name="pg_major" value="<?php echo $row3[2] ?>"></td>
                                    <td><input type="number" name="pg_gpa" value="<?php echo $row3[3] ?>"></td>
                                    <td><input type="text" name="pg_university" value="<?php echo $row3[4] ?>"></td>
                                    <td><input type="text" name="pg_country" value="<?php echo $row3[5] ?>"></td>
                                    <td><input type="number" name="pg_year" value="<?php echo $row3[6] ?>"></td>
                                    <?php
                                }
                                ?>
                            </tr>
